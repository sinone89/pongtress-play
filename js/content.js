...
const ROSTER = [
  ...
  { id: 'knight', cls: 'gunner', name: '루비', weapon: '리볼버 캐논', rarity: 'common', atk: 8, hp: 30, gol: 1,
    concept: '빨간 베레모의 신참 소녀. 회전 탄창이 달린 소형 리볼버형 캐논을 든 발랄한 모습',
    active: { name: '직격탄', gauge: 12, kind: 'bigHit', mult: 3 },
    passive: { name: '예광탄', kind: 'addPeg', peg: 'mult2', n: 1 } },
  { id: 'archer', cls: 'gunner', name: '미나', weapon: '개틀링 캐논', rarity: 'rare', atk: 10, hp: 26, gol: 2,
    concept: '크림슨·블랙 전술복에 트윈테일. 다총열 회전 개틀링형 캐논으로 속사하는 활발한 소녀',
    active: { name: '풀버스트', gauge: 15, kind: 'extraShots', shots: 4 },
    passive: { name: '탄창 보급', kind: 'addBall', n: 1 } },
  { id: 'berserker', cls: 'gunner', name: '카린', weapon: '중장 캐논', rarity: 'epic', atk: 14, hp: 34, gol: 1,
    concept: '긴 흑발에 크림슨 롱코트. 묵직한 장포신의 중장 캐논을 든 쿨한 에이스 소녀',
    active: { name: '난사', gauge: 16, kind: 'bigHit', mult: 4 },
    passive: { name: '화력 증강', kind: 'addPeg', peg: 'attack', n: 1 } },
  { id: 'valkyrie', cls: 'gunner', name: '발키리', weapon: '미니건 캐논', rarity: 'legendary', atk: 18, hp: 34, gol: 2,
    concept: '백금·핑크빛 롱헤어에 흑·금 제복과 날개 장식. 거대 다총열 미니건형 캐논을 든 정예 발키리 소녀(골드 트림)',
  ...
  { id: 'grenadier', cls: 'cannon', name: '보라', weapon: '산탄 캐논', rarity: 'common', atk: 7, hp: 34, gol: 2,
    concept: '주황 단발에 올리브·오렌지 군용 재킷. 나팔형 광역 산탄 캐논을 든 명랑한 신참 소녀',
    active: { name: '산탄 사격', gauge: 15, kind: 'aoe', count: 3, shots: 1, mult: 1.4 },
    passive: { name: '예광탄', kind: 'addPeg', peg: 'mult2', n: 1 } },
  { id: 'mortar', cls: 'cannon', name: '하나', weapon: '박격 캐논', rarity: 'rare', atk: 9, hp: 36, gol: 2,
    concept: '만두머리에 오렌지·블랙 복장. 짧고 굵은 곡사 박격형 캐논을 짊어진 씩씩한 소녀',
    active: { name: '박격 포격', gauge: 15, kind: 'aoe', count: 3, shots: 1, mult: 1.6 },
    passive: { name: '탄창 보급', kind: 'addBall', n: 1 } },
  { id: 'mage', cls: 'cannon', name: '티아', weapon: '곡사 캐논', rarity: 'epic', atk: 12, hp: 30, gol: 2,
    concept: '앰버빛 롱헤어. 화려한 장식의 곡사 장포 캐논 옆에 선 당당한 포격 에이스 소녀',
    active: { name: '포격', gauge: 15, kind: 'aoe', count: 4, shots: 1, mult: 1.6 },
    passive: { name: '고폭탄', kind: 'addPeg', peg: 'mult5', n: 1 } },
  { id: 'behemoth', cls: 'cannon', name: '레지나', weapon: '거포 캐논', rarity: 'legendary', atk: 15, hp: 40, gol: 2,
    concept: '흑·핑크 세일러 군복에 백금/핑크 롱헤어. 금장식 거대 거포(자주포형) 캐논을 다루는 여왕 같은 소녀(골드 트림·플래그십)',
    active: { name: '융단 폭격', gauge: 17, kind: 'aoe', count: 5, shots: 1, mult: 1.8 },
    passive: { name: '고폭탄', kind: 'addPeg', peg: 'mult5', n: 1 } },
  // ── 지원(support): 수리·제어·버프 ── atk↓ hp↑ gol↑ · 민트·시안 계열
  { id: 'guard', cls: 'support', name: '코코', weapon: '방패 캐논', rarity: 'common', atk: 3, hp: 52, gol: 3,
    concept: '민트빛 짧은 머리. 라이엇 방패와 일체형 산탄 캐논을 든 든든하고 귀여운 소녀',
    active: { name: '방벽 전개', gauge: 18, kind: 'heal', amount: 24 },
    passive: { name: '진지 구축', kind: 'closeBlank', n: 1 } },
  { id: 'rogue', cls: 'support', name: '루미', weapon: '소음 캐논', rarity: 'rare', atk: 6, hp: 34, gol: 2,
    concept: '은민트 단발에 다크 슈트. 소음기 달린 소형 캐논으로 섬광탄을 쏘는 조용한 침투 요원 소녀',
    active: { name: '섬광탄', gauge: 14, kind: 'stun', count: 3, turns: 1 },
    passive: { name: '지뢰 설치', kind: 'addPeg', peg: 'bumper', n: 1 } },
  { id: 'priest', cls: 'support', name: '미라', weapon: '정비 캐논', rarity: 'epic', atk: 5, hp: 44, gol: 2,
    concept: '민트 트윈테일에 테크 드레스. 수리 드론이 탑재된 지원 캐논을 다루는 정비병 소녀',
    active: { name: '나노 수리', gauge: 16, kind: 'heal', amount: 42 },
    passive: { name: '보급 드론', kind: 'closeBlank', n: 1 } },
  { id: 'seraph', cls: 'support', name: '세라', weapon: '지원 캐논', rarity: 'legendary', atk: 7, hp: 50, gol: 3,
    concept: '백·민트 롱헤어에 후광·날개. 드론을 사출하는 지원 캐논을 거느린 천사 같은 사령관 소녀(골드 트림)',
